...
byte Medicamento1[7]= {0x04, 0x18, 0xC2, 0x5A, 0x51, 0x59, 0x81} ; //código del usuario 1
byte Medicamento2[7]= {0x04, 0x06, 0xC2, 0x5A, 0x51, 0x59, 0x81} ; //código del usuario 2
void loop() {
