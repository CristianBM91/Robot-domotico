...
public class EnlaceActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    private static final int MY_PERMISSIONS_REQUEST_ACCESS_COARSE_LOCATION=1;
    // Consejo: utiliza como SERVICE_ID el nombre de tu paquete
    private static final String SERVICE_ID = "com.naranjatradicionaldegandia.elias";
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        String valor = "involuntario";
        if(extras != null){
            valor = extras.getString("inicio");
        }

        if(pref.getBoolean("configrp", false) && valor.equals("involuntario")){
            Intent i = new Intent(EnlaceActivity.this, SesionActivity.class);
            i.putExtra("exito", "si");
            startActivity(i);
        }
                ...
                @Override public void onConnectionResult(String endpointId,
                    ...
                    switch (result.getStatus().getStatusCode()) {
                        case ConnectionsStatusCodes.STATUS_OK:
                            ...
                            handler.postDelayed(new Runnable() {
                                ...
                                public void run() {
                                        ...
                                        Log.d(TAG, "Lanzando SesionActivity");
                                        //startActivity(new Intent(EnlaceActivity.this, MainActivity.class));
                        ...
                        case ConnectionsStatusCodes.STATUS_CONNECTION_REJECTED:
                            ...
                            textview.setText("Desconectado");
                            Toast.makeText(getApplicationContext(), "La conexión ha sido rechazada. Por favor, reinicia la aplicación y vuelve a intentarlo", Toast.LENGTH_SHORT).show();
                            break;
                        case ConnectionsStatusCodes.STATUS_ERROR:
                            Log.i(TAG, "Conexión perdida antes de poder ser " +
                                    "aceptada");
                            textview.setText("Desconectado");
                            Toast.makeText(getApplicationContext(), "La conexión se ha perdido. Por favor, reinicia la aplicación y vuelve a intentarlo", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }
    ...
    public static void sendData(String endpointId, String mensaje, Activity actividad) {
        ...
        Nearby.getConnectionsClient(actividad).sendPayload(endpointId, data);
        Log.i(TAG, "Mensaje enviado.");
    }
