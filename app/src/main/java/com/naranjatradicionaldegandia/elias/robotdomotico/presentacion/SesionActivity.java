...
import static com.naranjatradicionaldegandia.elias.robotdomotico.usuario.Usuarios.guardarUsuario;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(SesionActivity.this, "Authentication failed.",
        ...
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                ...
                this, new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    public void onCodeSent(String verificationId,
                        ...
                        SesionActivity.this.enableUserManuallyInputCode();
                    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(SesionActivity.this, "Fallo de autentificación.",
                                    Toast.LENGTH_SHORT).show();
                            updateUI(null);
                        }
